...
describe('auth API endpoints', () => {
  it('should return 404 if action is not login/logout/signup', async () => {
  ...
  describe('POST /api/signup', () => {
    ...
    it('should save user to session/log user in with signup', async () => {
      vi.spyOn(db.user, 'create')
        .mockImplementationOnce(vi.fn(async () => ({username: "banana", id: "myid"})))
      const req = createRequest({
        method: "POST",
    ...
    it('should return 400 with error from db.user.create', async () => {
      vi.spyOn(db.user, 'create')
  ...
  describe('POST /api/login', () => {
    ...
    it('should return 400 when db.auth.login errors and pass error message as {error: msg}', async () => {
    ...
    it('should return 200 when given username/password', async () => {
