...
describe('book API endpoints', () => {
  describe('POST /api/book', () => {
    ...
    it('should return 401 if user not found and destroy session', async () => {
      const book = bookSearchResults[0]
      vi.spyOn(db.book, 'add').mockImplementationOnce(vi.fn(async () => null))
      const req = createRequest({
        method: 'POST',
    ...
    it('should return 400 and JSON {error: error.message} from db.book.add', async () => {
      const book = bookSearchResults[0]
  ...
  describe('DELETE /api/book', () => {
    ...
    it('should return 400 and JSON {error: error.message} from db.book.remove', async () => {
      const book = {...bookSearchResults[0], id: 'bookid'}
