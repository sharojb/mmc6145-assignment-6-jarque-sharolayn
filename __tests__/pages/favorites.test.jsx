...
describe('Favorites page', () => {
  describe('getServerSideProps', () => {
    ...
    it('should pass favoriteBooks prop if user is logged in', async () => {
      vi.spyOn(db.book, 'getAll')
    ...
    it('should log user out by redirecting to login if db.books.getAll does not find user', async () => {
      vi.spyOn(db.book, 'getAll')
        .mockImplementationOnce(vi.fn(async () => null))
      const req = createRequest({
        method: "GET"
